...
https://travis-ci.com/saltstack-formulas/proftpd-formula[image:https://travis-ci.com/saltstack-formulas/proftpd-formula.svg?branch=master[Travis CI Build Status]]
